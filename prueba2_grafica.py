...
selected_option = option_menu(
    menu_title=None,
    options=["Introducción", "Data", "Mapas", "Gráfico Circular", "Distribución por distrito", "Sobre Nosotros"],  # Opciones del menú
...
if selected_option == "Introducción":
...
elif selected_option == "Distribución por distrito":
    ...
    if not distritos_data.empty:
        fig_distritos = px.bar(
            ...
            y="TOTAL_RESIDUOS",
            text="TOTAL_RESIDUOS",
            labels={"DISTRITO": "Distrito", "TOTAL_RESIDUOS": "Toneladas de Residuos"},
